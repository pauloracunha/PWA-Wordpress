...
function pwa_config_panel(){
	...
	add_menu_page('Wear Notify', 'Wear Notify', 'manage_options', 'pwa', 'pwa_module_dashboard', $icon_svg, 7);
...
if(!function_exists('pwa_btn_action')){
	...
	function pwa_btn_action(){
		...
		<style>
			...
			#sleepwear-notification:hover{
				opacity: 1;
			}
			#sleepwear-notification>img{
				width: 100%;
				height: auto;
				cursor: pointer;
			}
			#sleepwear-notification>span {
			    position: absolute;
			    bottom: -.5em;
			    left: 3vw;
			    width: 17vw;
			...
			#sleepwear-notification:hover>span{
				display:block;
			}
			#sleepwear-notification>span>i {
			    position: absolute;
			    left: -.4em;
			    top: calc(50% - .5em);
			    height: 100%;
			}
			#sleepwear-notification>span>button{
				padding: .5em;
				border-radius: .1em;
				background-color: var(--sleep-bg-third)
			}
		</style>
		<span id="sleepwear-notification">
